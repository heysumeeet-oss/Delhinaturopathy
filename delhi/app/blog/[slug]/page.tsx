...
export default function BlogPostPage({ params }: Props) {
  ...
  const breadcrumbJson = generateBreadcrumbSchema([
    ...
    { name: 'Blog', url: 'https://delhinaturopath.in/blog' },
    { name: post.title, url: `https://delhinaturopath.in/blog/${post.slug}` }
  ]);
  ...
  const articleJson = {
    ...
    "headline": post.title,
    "description": post.excerpt,
    "image": "https://delhinaturopath.in/opengraph-image", // Fallback to OG image
    "author": {
      "@type": "Person",
      "name": post.author
    },
