...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${condition.title} Natural Treatment in Delhi | Symptoms & Cure`,
    description: `Best Naturopathy treatment for ${condition.title} in Delhi. ${condition.shortDescription}`,
    keywords: [`${condition.title} cure Delhi`, `Naturopathy for ${condition.title}`, ...condition.symptoms],
    alternates: {
...
export default function ConditionDetail({ params }: Props) {
  ...
  const breadcrumbJson = generateBreadcrumbSchema([
    ...
    { name: 'Conditions', url: 'https://delhinaturopath.in/conditions' }, // Assuming a conditions listing exists or purely for structural hierarchy
