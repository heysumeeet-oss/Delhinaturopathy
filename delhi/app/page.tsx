...
export const metadata: Metadata = {
  title: "No.1 Naturopathy in Delhi, Natural Treatment Hospital, Naturopath Doctor | Holistic Healing Delhi",
};

export default function Home() {
  return (
    <div className="min-h-screen flex flex-col font-sans bg-light-gray">
      <Header />
