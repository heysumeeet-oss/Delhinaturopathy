...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: "2023-11-05",
    text: "Best Naturopathy centre in Delhi! I joined for weight loss and lost 8kg in 2 months with just diet and yoga. No medicines, no side effects. The detox diet plan is very effective.",
  ...
  },
  {
    ...
    rating: 5,
    date: "2023-09-20",
    text: "My diabetes levels were uncontrollable (HbA1c was 9.2). After 3 months of treatment here, it's down to 6.5 without heavy medication. The mud therapy and karela juice diet really works. Dr. Ananya is very knowledgeable.",
  ...
  },
  {
    ...
    rating: 5,
    date: "2023-12-12",
    text: "Friendly staff and hygienic center. Best place for hydrotherapy in Delhi. The spinal spray is very refreshing.",
  ...
  },
  {
    ...
    rating: 5,
    date: "2023-11-15",
    text: "Being a doctor myself, I appreciate their scientific approach to natural healing. No quackery, just pure science of body and nature. Dr. Ananya is a gem.",
    treatment: "Wellness",
    location: "Faridabad"
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    date: "2023-09-18",
    text: "Affordable and effective. I compared prices with other naturopathy centers in Delhi, and this one offers the best value. Plus the doctor is very senior.",
